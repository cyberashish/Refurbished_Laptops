...
const Header = () => {
  ...
  return (
   ...
   <div className="flex items-center justify-between lg:py-3 py-4 px-6">
     <Image src={logo} alt="image" className="w-40 lg:order-1 order-2" />
     ...
     <Icon icon="material-symbols:menu-rounded" className="text-2xl lg:hidden block lg:order-2 order-1"  />
