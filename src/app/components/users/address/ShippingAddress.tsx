...
const ShippingAddress = ({handleOpen}:any) => {
  ...
  const initialValues = useMemo(() => (
    ...
    const {getShippingAddresses , setTrackIsDefaultAddress , userShippingAddress} = useContext(UserContext);
                ...
                <div className="grid grid-cols-12 gap-6">
                  <div className="lg:col-span-6 col-span-12">
                    <input
                      ...
                      onBlur={handleBlur}
                      onFocus={(e) => {
                        e.target.classList.add("focus:border-primary"); // Optional: Add focus styles dynamically
                      }}
                    />
