export default function Faq(){
    return (
        ...
        <span className="text-sm w-fit relative text-secondary after:absolute after:-right-12 after:top-1/2 after:-translate-y-1/2 after:w-10 after:h-[1px] after:bg-secondary before:absolute before:top-1/2 before:-left-12 before:-translate-y-1/2 before:w-10 before:h-[1px] before:bg-secondary font-semibold">
          ...
          <h3 className="text-[28px] font-semibold text-dark text-center">Frequently Asked Question</h3>
           </div>
                ...
                <p className="text-gray-800 dark:text-neutral-200">
                  <ol className="flex flex-col gap-2">
                    <li className="text-[15px] font-medium">
                      ...
                      often sold at a fraction of the cost of a new laptop. This
                      means that you can get a high-quality laptop that fits
                      your budget.
                    </li>
                    <li className="text-[15px] font-medium">
                      <strong>Environmentally friendly:</strong> When you buy a
                      refurbished laptop, you&apos;re helping to reduce electronic
                      waste. Electronic waste is a significant problem
                      worldwide, and by recycling electronic devices like
                      laptops, we can help reduce the amount of waste that ends
                      up in landfills.
                    </li>
                    <li className="text-[15px] font-medium">
                      <strong>Quality:</strong> Refurbished laptops are tested
                      and repaired by professionals to ensure that they&apos;re in
                      good condition. This means that you can get a high-quality
                      laptop that&apos;s just like new.
                    </li>
                  </ol>
                </p>
              </div>
            ...
            >
              <div className="pb-4 px-5">
                <p className="text-sm font-medium text-dark">
                  There are several benefits to buying a refurbished laptop from
                  Newjaisa. First and foremost, our refurbished laptops are
                  significantly more affordable than buying a brand new laptop,
                  making it a great option for customers on a tight budget.
                  Additionally, buying a refurbished laptop from Newjaisa helps
                  reduce electronic waste by extending the life of an existing
                  device, and it&apos;s a more environmentally - friendly option than
                  buying a new laptop.
                </p>
              </div>
            </div>
            ...
            >
              <div className="pb-4 px-5">
                <p className="text-dark text-sm font-medium">
                  At Newjaisa we provide a 1 year warranty to all customers for
                  our every product. and Customer Support for our users. Any
                  customer can contact 80884 03455 (Mon-Sat between 10AM to 7PM)
                  or drop the mail at -support@newjaisa.com
                </p>
              </div>
            </div>
          </div>
                ...
                <p className="text-dark text-sm font-medium">
                  <ul className="list-disc list-inside flex flex-col gap-2"  >
                    <li className="text-[15px] font-medium">
                      ...
                      and returns. The following terms are applicable for any
                      products that You purchased with Us. You are entitled to
                      return your order within 14 days of receiving it.To start
                      a return, you can contact us at support@newjaisa.com. If
                      your return is accepted, we’ll send you instructions on
                      how and where to send your package. Items sent back to us
                      without first requesting a return will not be accepted.
                      For Return/Replacement Queries you can reach out to us on
                      :
                    </li>
                    <li className="text-[15px] font-medium">
                      Email ID :
